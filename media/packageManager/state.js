...
(function () {
    ...
    window.PM.state = {
        ...
        environmentDetailsExpanded: false,
        runTerminalTarget: 'auto',
        runTerminalTargetOptions: [],
        runEnvironmentTarget: 'auto',
        runEnvironmentOptions: [],
        runTerminalMode: 'auto',
        runTerminalModeOptions: [],
        autoLaunchInExternalTerminal: true,
        currentConfigId: '',
